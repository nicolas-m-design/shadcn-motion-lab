...
export const motionSections: MotionSection[] = [
  {
    ...
    status: 'live',
    variants: ['Standard', 'Snappy', 'Expressive', 'Slow-mo', 'Reduced motion'],
  },
  {
    slug: 'drawer',
    title: 'Drawer',
  ...
  },
  {
    ...
    status: 'live',
    variants: ['Single', 'Burst', 'Stack collapsed', 'Stack expanded', 'Reduced motion'],
  },
  {
    slug: 'tooltip',
    title: 'Tooltip',
    goal: 'Reveal contextual help without slowing the cursor.',
    status: 'live',
    variants: ['Standard', 'Snappy', 'Expressive', 'Slow-mo', 'Reduced motion'],
  },
  {
